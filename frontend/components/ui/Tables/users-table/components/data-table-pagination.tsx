...
export function DataTablePagination<TData>({ table, }: DataTablePaginationProps<TData>) {
    return (
        <div className="flex flex-col md:flex-row items-center justify-between px-2 space-y-4 md:space-y-0">
            ...
            <div className="flex items-center justify-between w-full md:w-auto lg:space-x-8 max-sm:flex-col max-sm:gap-4">
                <div className="flex items-center space-x-2 mr-4 max-sm:mr-0 max-sm:ml-1">
